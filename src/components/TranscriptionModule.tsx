...
import { Upload, FileAudio, FileVideo, Download, Play, Pause, Volume2, Clock, CheckCircle, AlertCircle, FileText, Eye, Sparkles, Search, Trash2, Calendar, File } from 'lucide-react';
    ...
    <div className="flex h-full bg-gray-50">
      ...
      <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-6 border-b border-gray-200">
          ...
          {/* Upload Zone */}
          <div
            className={`relative border-2 border-dashed rounded-lg p-6 text-center transition-all duration-300 mb-4 ${
              dragActive
              ...
              >
                ...
                {file.status === 'completed' && file.confidence && (
                  <div className="mt-2 text-xs text-purple-600 bg-purple-100 rounded-lg p-2">
                    Confiance: {Math.round(file.confidence * 100)}%
                    {file.summaryWordCount && (
          ...
          <>
            ...
            <div className="bg-white border-b border-gray-200 p-6">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                ...
                <span>•</span>
                <span>Uploadé le {selectedFile.uploadedAt.toLocaleDateString()}</span>
                {selectedFile.confidence && (
                  <>
                    <span>•</span>
                    <span className="text-green-600 font-medium">
                      Confiance: {Math.round(selectedFile.confidence * 100)}%
                    </span>
                  </>
                )}
              </div>
